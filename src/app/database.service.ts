    ...
    constructor() {
      ...
      this._db.info().then((infos) => {
        ...
        if (infos.doc_count <= 0) { // init the db
          let rows=[{"id":"configuration/main","key":"configuration/main","value":{"rev":"3-ac59a4324e71a835a7089d56f112236e"},"doc":{"enable_physical_button":false,"use_external_screen":false,"lastname_is_mandatory":true,"contact_is_mandatory":false,"city_is_mandatory":false,"section":"main","id_active_event":"event/1478624261077","_id":"configuration/main","_rev":"3-ac59a4324e71a835a7089d56f112236e"}},{"id":"event/1478624261077","key":"event/1478624261077","value":{"rev":"9-b6c5b33c778a8bf0ad22ac74d65db823"},"doc":{"name":"Un évênement de test","description":"Une petite description","start_date":"2016-01-01","end_date":"2016-01-01","commitments":[{"id":"1","name":"Je ne gaspille plus mon pain rassis","short_description":"Faites du pain perdu ou de la\nchapelure avec votre pain rassis !","description":"La description est à définir","alternative_text": "","image":"assets/img/bread.jpg","logo":"assets/img/bread-icon.png","ask_for_persons":true,"ask_for_periodicity":true,"m2_saved_by_unit":"25","euros_saved_by_unit":"9","order":0,"active":true},{"id":"2","name":"Je ne jette plus mes yaourts périmés","short_description":"Vos yaourts périmés sont toujours comestibles !","description":"La description qui va dans le popup","alternative_text": "","image":"assets/img/bread.jpg","logo":"assets/img/bread-icon.png","ask_for_persons":true,"ask_for_periodicity":true,"m2_saved_by_unit":"3","euros_saved_by_unit":"8","order":"1","active":true},{"id":"3","name":"J’opte pour un repas végétarien plus souvent","short_description":"Essayez un repas végétarien\nde temps en temps !","description":"La description","alternative_text": "","image":"assets/img/bread.jpg","logo":"assets/img/bread-icon.png","ask_for_persons":false,"ask_for_periodicity":true,"m2_saved_by_unit":"260","euros_saved_by_unit":"44","order":"3","active":true}],"_id":"event/1478624261077","_rev":"9-b6c5b33c778a8bf0ad22ac74d65db823"}}];
/*
          console.log("json 2");
