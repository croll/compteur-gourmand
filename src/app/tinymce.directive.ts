  ...
  _initEditor() {
    return new Promise((resolve, reject) => {
        ...
        this.editor = tinymce.init({
          ...
          // inline: true,
          menubar: false,
          toolbar: 'customsave | undo redo | bold italic underline strikethrough | fontsizeselect | forecolor | backcolor | alignleft aligncenter alignright alignjustify | table | image | code',
          plugins: 'textcolor colorpicker image autoresize fullscreen table code',
